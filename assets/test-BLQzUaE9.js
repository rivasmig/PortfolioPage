...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Video embeds"})," and rich media content"]}),`
`]}),`
...
`,e.jsx(s,{}),`
`,e.jsx(n.h2,{children:"Video Test 🎬"}),`
`,e.jsx(n.p,{children:"Let's test video embedding capabilities:"}),`
`,e.jsx(o,{}),`
...
`,e.jsx(n.hr,{}),`
`,e.jsx(n.p,{children:e.jsx(n.em,{children:"This test file demonstrates the perfect balance between simplicity and capability."})})]})}function c(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(i,{...r})}):i(r)}export{s as ClickCounter,o as VideoEmbed,c as default};
